...
class Activity(ActivitySummary):
    ...
    variability_index: float | None = Field(default=None, alias="icu_variability_index")
    efficiency_factor: float | None = Field(default=None, alias="icu_efficiency_factor")
    tss: float | None = None
